...
Version: 9.4
Status: **ACTIVE / R3_A_TO_H_COMPLETE / R3C_OAUTH_RECOVERY_PASS / R4_PACKAGE_READY / PRIVATE_ASSEMBLY_REQUIRED / R4_CUTOVER_HOLD / FREE_ONLY / PUBLICATION_HOLD**
Updated: 2026-09-22
...
10. `02_ROADMAP.md` — v8.1.
11. `06_DECISION_LOG.md` — v5.4.
12. `08_CHAT_HANDOFF.md` — v6.4.
13. current PR #22 / PR #45 state and current runtime evidence.

Historical checkpoints remain valid evidence but do not override checkpoint 167 or CURRENT_HANDOFF.
