...
Reuse COMPLETED/PROCESSING. FAILED free-only may be freshly retried once only on a new explicit retry request; never auto-loop; paid/charge-uncertain replay stays blocked.
