...
Version: 9.5
Status: **ACTIVE / R3_A_TO_H_COMPLETE / R3C_OAUTH_RECOVERY_PASS / R4_PACKAGE_CORRECTED / E1_OAUTH_HARDENING_REQUIRED / PRIVATE_ASSEMBLY_REQUIRED / R4_CUTOVER_HOLD / FREE_ONLY / PUBLICATION_HOLD**
Updated: 2026-09-22
...
11. `02_ROADMAP.md` — v8.2.
12. `06_DECISION_LOG.md` — v5.5.
13. `08_CHAT_HANDOFF.md` — v6.5.
14. current PR #22 / PR #45 state and current runtime evidence.

Historical checkpoints remain valid evidence but do not override checkpoint 168 or CURRENT_HANDOFF.
