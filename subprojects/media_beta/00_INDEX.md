...
1. `CURRENT_HANDOFF.md` — v21.9.
2. `194_NATIVE_PLUGIN_MIGRATION_PREFLIGHT_PASS_MEDIA_REBIND_PREBUILD_NEXT_2026_09_24.md`.
...
R4_C=NATIVE_MIGRATION_PREFLIGHT_PASS / MEDIA_REBIND_PREBUILD_NEXT
...
CURRENT_GATE=MEDIA_REBIND_PREBUILD
```
...
PUBLIC_GPT_ROLLBACK_ANCHOR=KEEP_PUBLISHED_AND_EDITABLE
```
