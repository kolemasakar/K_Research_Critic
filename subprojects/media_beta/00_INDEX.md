...
Version: 9.9
Status: **ACTIVE / R3_A_TO_H_COMPLETE / R4_A_COMPLETE / R4_B_IN_PROGRESS / STATIC_REGRESSION_PASS / LIVE_CANDIDATE_RESELECT_REQUIRED / R4_CUTOVER_HOLD / FREE_ONLY / PUBLICATION_HOLD**
Updated: 2026-09-22
...
13. `02_ROADMAP.md` — v8.6.
14. `06_DECISION_LOG.md` — v5.9.
15. `08_CHAT_HANDOFF.md` — v6.9.
16. current PR #22 / PR #45 state and current runtime evidence.

Historical checkpoints remain valid evidence but do not override checkpoint 172 or CURRENT_HANDOFF.
