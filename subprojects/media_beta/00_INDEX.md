...
Version: 9.8
Status: **ACTIVE / R3_A_TO_H_COMPLETE / R4_A_COMPLETE / A5_PASS / A6_COMPLETE / R4_B_PENDING_AUTHORIZATION / R4_CUTOVER_HOLD / FREE_ONLY / PUBLICATION_HOLD**
Updated: 2026-09-22
...
12. `02_ROADMAP.md` — v8.5.
13. `06_DECISION_LOG.md` — v5.8.
14. `08_CHAT_HANDOFF.md` — v6.8.
15. current PR #22 / PR #45 state and current runtime evidence.

Historical checkpoints remain valid evidence but do not override checkpoint 171 or CURRENT_HANDOFF.
