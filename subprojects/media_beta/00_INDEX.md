...
Version: 10.10
Status: **ACTIVE / R3_9_UNIFIED_KRC_GPT_ACTIVE / 91_TESTS_PASS / NATIVE_MIGRATION_TRIGGER_CONFIRMED / PRIVATE_STAGING_NEXT / PUBLIC_GPT_UNCHANGED / R4_C_DEFERRED / FREE_ONLY**
Updated: 2026-09-22
...
13. `02_ROADMAP.md` — v9.7.
14. `06_DECISION_LOG.md` — v6.10.
15. `08_CHAT_HANDOFF.md` — v7.10.
16. current PR #22 / PR #45 state and current runtime evidence.

Historical checkpoints remain valid evidence but do not override checkpoint 183 or CURRENT_HANDOFF.
