...
Version: 10.3
Status: **ACTIVE / R3_A_TO_H_COMPLETE / R4_A_COMPLETE / R4_B_COMPLETE / PRIVATE_REPLACEMENT_ACCEPTED / R4_C_READY_NOT_AUTHORIZED / FREE_ONLY / PUBLICATION_HOLD**
Updated: 2026-09-22
...
13. `02_ROADMAP.md` — v9.0.
14. `06_DECISION_LOG.md` — v6.3.
15. `08_CHAT_HANDOFF.md` — v7.3.
16. current PR #22 / PR #45 state and current runtime evidence.

Historical checkpoints remain valid evidence but do not override checkpoint 176 or CURRENT_HANDOFF.
