...
Version: 10.9
Status: **ACTIVE / R3_9_UNIFIED_KRC_GPT_ACTIVE / STATIC_PASS / PUBLIC_GPT_UNCHANGED / R4_C_PAUSED / FREE_ONLY**
Updated: 2026-09-22
...
13. `02_ROADMAP.md` — v9.6.
14. `06_DECISION_LOG.md` — v6.9.
15. `08_CHAT_HANDOFF.md` — v7.9.
16. current PR #22 / PR #45 state and current runtime evidence.

Historical checkpoints remain valid evidence but do not override checkpoint 182 or CURRENT_HANDOFF.
