...
Version: 10.2
Status: **ACTIVE / R3_A_TO_H_COMPLETE / R4_A_COMPLETE / R4_B_IN_PROGRESS / B1_PASS / B2_READONLY_429_FIX_DEPLOYED / B2_FINAL_AUTH_RERUN_PENDING / B3_PASS / R4_CUTOVER_HOLD / FREE_ONLY / PUBLICATION_HOLD**
Updated: 2026-09-22
...
13. `02_ROADMAP.md` — v8.9.
14. `06_DECISION_LOG.md` — v6.2.
15. `08_CHAT_HANDOFF.md` — v7.2.
16. current PR #22 / PR #45 state and current runtime evidence.

Historical checkpoints remain valid evidence but do not override checkpoint 175 or CURRENT_HANDOFF.
