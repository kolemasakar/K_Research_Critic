...
Version: 10.6
Status: **ACTIVE / R3_A_TO_H_COMPLETE / R4_A_COMPLETE / R4_B_COMPLETE / PRIVATE_REPLACEMENT_ACCEPTED / R4_C_IN_PROGRESS / WEB_LINK_ONLY_PATH_UNAVAILABLE / DISTRIBUTION_DECISION_PENDING / ZERO_MUTATION / FREE_ONLY**
Updated: 2026-09-22
...
13. `02_ROADMAP.md` — v9.3.
14. `06_DECISION_LOG.md` — v6.6.
15. `08_CHAT_HANDOFF.md` — v7.6.
16. current PR #22 / PR #45 state and current runtime evidence.

Historical checkpoints remain valid evidence but do not override checkpoint 179 or CURRENT_HANDOFF.
