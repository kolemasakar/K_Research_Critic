...
Version: 9.1
Status: **ACTIVE / R3_A_TO_H_COMPLETE / R4_READONLY_PREFLIGHT_COMPLETE / OWNER_CUTOVER_DECISION_PENDING / FREE_ONLY / PUBLICATION_HOLD**
Updated: 2026-09-21
...
7. `02_ROADMAP.md` — v7.8.
8. `06_DECISION_LOG.md` — v5.1.
9. `08_CHAT_HANDOFF.md` — v6.1.
10. current PR #22 / PR #45 state and current runtime evidence.

Historical checkpoints remain valid evidence but do not override checkpoint 164 or CURRENT_HANDOFF.
